                       ...
                       public SurgeSynthesizer::ModulationAPIListener
{
  ...
  private:
    ...
    // DeepSynth panel
    std::unique_ptr<Surge::GUI::Panels::DeepSynthPanel> deepSynthPanel;
    
    // DeepSynth panel state preservation
    struct DeepSynthPanelState {
